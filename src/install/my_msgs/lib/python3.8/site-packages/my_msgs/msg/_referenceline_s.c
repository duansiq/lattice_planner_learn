...
bool my_msgs__msg__referenceline__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_msgs.msg._referenceline.Referenceline", full_classname_dest, 40) == 0);
  }
  my_msgs__msg__Referenceline * ros_message = _ros_message;
  {  // header
...
PyObject * my_msgs__msg__referenceline__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_msgs.msg._referenceline");
