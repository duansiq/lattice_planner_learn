...
#include "my_msgs/msg/detail/referenceline__rosidl_typesupport_fastrtps_c.h"
...
using _Referenceline__ros_msg_type = my_msgs__msg__Referenceline;
...
size_t get_serialized_size_my_msgs__msg__Referenceline(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Referenceline__ros_msg_type * ros_message = static_cast<const _Referenceline__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Referenceline__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msgs__msg__Referenceline(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msgs
size_t max_serialized_size_my_msgs__msg__Referenceline(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_msgs__msg__Referenceline(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, msg, Referenceline)() {
