...
: ${AMENT_CURRENT_PREFIX:="/root/planner_ws/src/install/lattice_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lattice_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lattice_planner/environment/path.sh"
