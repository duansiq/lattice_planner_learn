...
void Cartesian_Frenet_Converter::cartesian_to_frenet(
...
void Cartesian_Frenet_Converter::frenet_to_cartesian(
    const double rs, const double rx, const double ry, const double rtheta,
...
double Cartesian_Frenet_Converter::CalculateTheta(const double rtheta,
                                                  const double rkappa,
                                                  const double l,
                                                  const double dl)
{
...
double Cartesian_Frenet_Converter::CalculateKappa(const double rkappa,
...
vector<double> Cartesian_Frenet_Converter::CalculateCartesianPoint(const double rtheta,
                                                                   const vector<double> &rpoint,
                                                                   const double l)
{
    vector<double> rpoint_(2, 0);
    const double x = rpoint[0] - l * std::sin(rtheta);
    const double y = rpoint[1] + l * std::cos(rtheta);
    rpoint_[0] = x;
    rpoint_[1] = y;
    return rpoint;
}

double Cartesian_Frenet_Converter::CalculateLateralDerivative(
...
double Cartesian_Frenet_Converter::CalculateSecondOrderLateralDerivative(
